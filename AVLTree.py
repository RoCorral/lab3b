# -*- coding: utf-8 -*-
"""
Created on Mon Nov  5 19:29:54 2018
...
#         current_node = self.root
#         while current_node is not None:
# #            print(current_node.key[:-1]) # used to debug and remove last str character that is a " "
# #            print(current_node.key[:-1] == 'cryptal')
# #            print('--------------------------------------------------------')
